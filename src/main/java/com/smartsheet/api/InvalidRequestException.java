...
/**
 * <p>This is the exception to indicate invalid request error returned from Smartsheet REST API.</p>
 * 
 * <p>Basically this exception will be thrown when the Smartsheet REST API responds with "400 BAD REQUEST".</p>
 * 
