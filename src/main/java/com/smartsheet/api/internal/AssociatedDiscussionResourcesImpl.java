...
public class AssociatedDiscussionResourcesImpl implements AssociatedDiscussionResources {
     ...
     * POST /row/{id}/discussions
     * 
     * Parameters:
     * - objectId : the ID of the object
     * - discussion : the discussion object limited to the following attributes:
     * * title
     * * comment
     * 
     * Returns:
     ...
     * 
     * Implementation:
     * return this.createResource(getMasterResourceType() + "/" + objectId + "/discussions", Discussion.class, discussion);
     * @param discussion 
     * @param objectId 
     * @return 
     */
