...
public class ShareResourcesImpl implements ShareResources {
     ...
     * 
     * Returns:
     * the shares (note that empty list will be returned if there is none)
     * 
     * Exceptions:
     ...
     * 
     * It mirrors to the following Smartsheet REST API method:
     * GET /workspace/{id}/share/{userId}
     * GET /sheet/{id}/share/{userId}
     * 
     * Parameters:
     * - objectId : the ID of the object to share
     * - userId : the ID of the user to whom the object is shared
     * 
     * Returns:
     ...
     * 
     * Implementation:
     * return this.createResource(getMasterResourceType() + "/" + objectId + "/shares?sendEmail=" + sendEmail, Share.class, share);
     * @param share 
     * @param objectId 
     * @param sendEmail 
     * @return 
     ...
     * 
     * It mirrors to the following Smartsheet REST API method:
     * POST /workspace/{id}/multishare
     * POST /sheet/{id}/multishare
     * 
     * Parameters:
     * - objectId : the ID of the object to share
     * - multiShare : the MultiShare object
     * 
     * Returns:
     * the created shares
     * 
     ...
     * 
     * Implementation:
     * return this.postAndReceiveList(getMasterResourceType() + "/" + objectId + "/multishare", multiShare, Share.class);
     * @param objectId 
     * @param multiShare 
     * @return 
     */
     ...
     * 
     * Implementation:
     * return this.postAndReceiveList(getMasterResourceType() + "/" + objectId + "/multishare?sendEmail=" + sendEmail, multiShare, Share.class);
     * @param objectId 
     * @param sendEmail 
     * @param multiShare 
     * @return 
     ...
     * 
     * It mirrors to the following Smartsheet REST API method:
     * DELETE /workspace/{id}/share/{userId}
