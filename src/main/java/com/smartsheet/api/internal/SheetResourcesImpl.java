 ...
 *
 * Thread Safety: This class is thread safe because it is immutable and its base
...
public class SheetResourcesImpl extends AbstractResources implements SheetResources {
     ...
     *
     * <p>
     * It mirrors to the following Smartsheet REST API method: GET /sheets</p>
     *
     * @param includes the source inclusion
     * @param pagination the object containing the pagination parameters
     * @return A list of all sheets (note that an empty list will be returned if
     * there are none).
     * @throws IllegalArgumentException if any argument is null or empty string
     * @throws InvalidRequestException if there is any problem with the REST API
     * request
     * @throws AuthorizationException if there is any problem with the REST API
     * authorization (access token)
     * @throws ResourceNotFoundException if the resource cannot be found
     * @throws ServiceUnavailableException if the REST API service is not
     * available (possibly due to rate limiting)
     * @throws SmartsheetException if there is any other error during the
     * operation
     */
     ...
     *
     * Exceptions: - InvalidRequestException : if there is any problem with the
     * REST API request - AuthorizationException : if there is any problem with
     * the REST API authorization(access token) - ServiceUnavailableException :
     * if the REST API service is not available (possibly due to rate limiting)
     * - SmartsheetRestException : if there is any other REST API related error
     * occurred during the operation - SmartsheetException : if there is any
     * other error occurred during the operation
     *
     * @param parameters the object containing the pagination parameters
     * @return all sheets (note that empty list will be returned if there is
     * none)
     ...
     * Exceptions: - InvalidRequestException : if there is any problem with the
     * REST API request - AuthorizationException : if there is any problem with
     * the REST API authorization(access token) - ResourceNotFoundException : if
     * the resource can not be found - ServiceUnavailableException : if the REST
     * API service is not available (possibly due to rate limiting) -
     * SmartsheetRestException : if there is any other REST API related error
     * occurred during the operation - SmartsheetException : if there is any
     * other error occurred during the operation
     *
     ...
     * currently DISCUSSIONS and ATTACHMENTS are supported.
     ...
     * @return the resource (note that if there is no such resource, this method
     * will throw ResourceNotFoundException rather than returning null).
     * @throws SmartsheetException the smartsheet exception
     */
     ...
     *
     * It mirrors to the following Smartsheet REST API method: GET /sheet/{id}
     * with "application/vnd.ms-excel" Accept HTTP header
     *
     * Exceptions: IllegalArgumentException : if outputStream is null
     * InvalidRequestException : if there is any problem with the REST API
     * request AuthorizationException : if there is any problem with the REST
     * API authorization(access token) ResourceNotFoundException : if the
     * resource can not be found ServiceUnavailableException : if the REST API
     * service is not available (possibly due to rate limiting)
     * SmartsheetRestException : if there is any other REST API related error
     * occurred during the operation SmartsheetException : if there is any other
     * error occurred during the operation
     *
     * @param id the id
     * @param outputStream the OutputStream to which the Excel file will be
     * written
     ...
     *
     * It mirrors to the following Smartsheet REST API method: GET /sheet/{id}
     * with "application/pdf" Accept HTTP header
     *
     * Exceptions: IllegalArgumentException : if outputStream is null
     * InvalidRequestException : if there is any problem with the REST API
     * request AuthorizationException : if there is any problem with the REST
     ...
     *
     * @param id the id
     * @param outputStream the output stream to which the PDF file will be
     * written.
     ...
     * InvalidRequestException : if there is any problem with the REST API
     * request AuthorizationException : if there is any problem with the REST
     * API authorization(access token) ServiceUnavailableException : if the REST
     * API service is not available (possibly due to rate limiting)
     * SmartsheetRestException : if there is any other REST API related error
     * occurred during the operation SmartsheetException : if there is any other
     * error occurred during the operation
     ...
     * attributes: * name (string) * columns (array of Column objects, limited
     * to the following attributes) - title - primary - type - symbol - options
    ...
    /**
     * Create a sheet (from existing sheet or template) in default "Sheets"
     * collection.
     *
     * It mirrors to the following Smartsheet REST API method: POST /sheets
     *
     ...
     *
     * @param sheet the sheet to create, limited to the following required
     * attributes: * name (string) * fromId (number): ID of the Sheet or
     * Template from which to create the sheet.
     * @param includes used to specify the optional objects to include,
     * currently DATA, DISCUSSIONS and ATTACHMENTS are supported.
     * @return the sheet
     * @throws SmartsheetException the smartsheet exception
     */
     ...
     *
     * It mirrors to the following Smartsheet REST API method: POST
     ...
     * @param sheet the sheet to create, limited to the following required
     * attributes: * name (string) * fromId (number): ID of the Sheet or
     * Template from which to create the sheet. - includes : used to specify the
     * optional objects to include, currently DATA, DISCUSSIONS and ATTACHMENTS
     * are supported.
     * @param includes the includes
     * @return the created sheet
     * @throws SmartsheetException the smartsheet exception
     ...
     *
     * <p>
     * It mirrors to the following Smartsheet REST API method: PUT
     * /sheet/{id}</p>
     *
     ...
     * Get a sheet version.
     *
     * It mirrors to the following Smartsheet REST API method: GET
     * /sheet/{id}/version
     *
     * Exceptions: InvalidRequestException : if there is any problem with the
     * REST API request AuthorizationException : if there is any problem with
     ...
     *
     * @param id the id
     * @return the sheet version (note that if there is no such resource, this
     * method will throw ResourceNotFoundException rather than returning null).
     * @throws SmartsheetException the smartsheet exception
     */
     ...
     *
     * It mirrors to the following Smartsheet REST API method: POST
     * /sheet/{sheetId}/emails
     *
     * Exceptions: - IllegalArgumentException : if any argument is null -
     * InvalidRequestException : if there is any problem with the REST API
     * request - AuthorizationException : if there is any problem with the REST
     * API authorization(access token) - ServiceUnavailableException : if the
     * REST API service is not available (possibly due to rate limiting) -
     * SmartsheetRestException : if there is any other REST API related error
     * occurred during the operation - SmartsheetException : if there is any
     * other error occurred during the operation
     *
    ...
    /**
     * <p>
     * Get a sheet as an Excel file.</p>
     *
     * <p>
     * It mirrors to the following Smartsheet REST API method:</p>
     * <p>
     * GET /sheet/{id} with "application/vnd.ms-excel" Accept HTTP header</p>
     *
     * @param id the id of the sheet
     * @param outputStream the output stream to which the Excel file will be
     * written.
     * @throws IllegalArgumentException if any argument is null or empty string
     * @throws InvalidRequestException if there is any problem with the REST API
     * request
    ...
    /**
     * Return the ShareResources object that provides access to Share resources
    ...
    /**
     * Return the SheetRowResources object that provides access to Row resources
     * associated with Sheet resources.
     *
    ...
    /**
     * Return the SheetColumnResources object that provides access to Column
     * resources associated with Sheet resources.
     *
    ...
    /**
     * Return the AssociatedAttachmentResources object that provides access to
     * attachment resources associated with Sheet resources.
     *
    ...
    /**
     * Return the AssociatedDiscussionResources object that provides access to
     * discussion resources associated with Sheet resources.
     *
    ...
    /**
     * <p>
     * Return the SheetCommentResources object that provides access to
     * discussion resources associated with Sheet resources.</p>
     *
     ...
     *
     * It mirrors to the following Smartsheet REST API method: GET
     * /sheet/{sheetId}/publish
     *
     * Returns: the resource (note that if there is no such resource, this
     * method will throw ResourceNotFoundException rather than returning null).
     *
     * Exceptions: - InvalidRequestException : if there is any problem with the
     * REST API request - AuthorizationException : if there is any problem with
    ...
    /**
     * Sets the publish status of a sheet and returns the new status, including
     * the URLs of any enabled publishings.
     *
     * It mirrors to the following Smartsheet REST API method: PUT
     * /sheet/{sheetId}/publish
     *
     ...
     *
     * @param id the id
     * @param publish the SheetPublish object limited to the following
     * attributes * readOnlyLiteEnabled * readOnlyFullEnabled * readWriteEnabled
     * * icalEnabled
     * @return the updated SheetPublish (note that if there is no such resource,
     * this method will throw ResourceNotFoundException rather than returning
     * null).
     * @throws SmartsheetException the smartsheet exception
     */
     ...
     *
     * Exceptions: IllegalArgumentException : if folder is null
     * InvalidRequestException : if there is any problem with the REST API
     * request AuthorizationException : if there is any problem with the REST
     * API authorization(access token) ServiceUnavailableException : if the REST
     * API service is not available (possibly due to rate limiting)
