...
public class UserResourcesImpl implements UserResources {
     ...
     * 
     * Parameters:
     * - user : the user object limited to the following attributes:
     * * admin
     * * email
     ...
     * 
     * Implementation:
     * return this.createResources("users?sendEmail=" + sendEmail, User.class, user);
     * @param sendEmail 
     * @param user 
     * @return 
     */
     ...
     * 
     * Parameters:
     * - user : the user to update limited to the following attributes :
     * * admin
     * * licensedSheetCreator
     * 
     * Returns:
     * the updated user (note that if there is no such resource, this method will throw ResourceNotFoundException rather than returning null).
     * 
     * Exceptions:
     * - IllegalArgumentException : if any argument is null
     * - InvalidRequestException : if there is any problem with the REST API request
     ...
     * 
     * Implementation:
     * return this.deleteResource("user/" + id, User.class);
     * @param id 
     */
