...
public class DefaultHttpClient implements HttpClient {
	...
	public HttpResponse request(HttpRequest request) throws HttpClientException {
		...
		if (httpRequest instanceof HttpEntityEnclosingRequestBase) {
			((HttpEntityEnclosingRequestBase)httpRequest).setEntity(new InputStreamEntity(
		...
		try {
			...
			HttpResponse response = new HttpResponse(); response.setHeaders(new HashMap<String, String>());
			...
			if (httpResponse.getEntity() != null) {
				...
				entity.setContentType(httpResponse.getEntity().getContentType().getValue());
				entity.setContentLength(httpResponse.getEntity().getContentLength());
				entity.setContent(httpResponse.getEntity().getContent()); response.setEntity(entity); 
			}
			return response; 
