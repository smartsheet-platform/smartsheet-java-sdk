...
public class DeleteUserParametersTest {
	...
	public void testToQueryString() {
		...
		assertEquals("?transferSheets=true&removeFromSharing=true&transferTo=12345", parameters.toQueryString());

		DeleteUserParameters parameters2 = new DeleteUserParameters(null, true, true);
		assertEquals("?transferSheets=true&removeFromSharing=true", parameters2.toQueryString());
